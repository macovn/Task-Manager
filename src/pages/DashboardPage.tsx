...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    { label: 'Đang thực hiện', value: tasks.filter(t => t.status === 'in_progress').length, icon: Clock, color: 'text-amber-600', bg: 'bg-amber-50' },
    { label: 'Chờ xử lý', value: tasks.filter(t => t.status === 'todo').length, icon: AlertCircle, color: 'text-red-600', bg: 'bg-red-50' },
  ];
